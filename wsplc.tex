...
problems occuring on power grids, especially the high attenuation and the existence
of several disruptors which generate
noise~\cite{itu_sim2016}. The solution recommended by the
G3-PLC standard is to use all the Smart Meter(SM) as a
...
density SM~\cite{g3plc_density2015}. The problem arises
especially in a rural environment where the distances
